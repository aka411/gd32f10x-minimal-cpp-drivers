 ...
 GPIO_P((GPIO_TypeDef*)( GPIO_BASE))
{
 ...
 void GPIO::setSPIMode()
 {
   ...
   */
   ...
   GPIO_P->CTL0  = (0x00U);//(0x44444444U);
   GPIO_P->CTL0 |= ( GPIO_CTL0_PIN_4_MD_OUTPUT_50HZ|
                     GPIO_CTL0_PIN_5_MD_OUTPUT_50HZ|
                     GPIO_CTL0_PIN_7_MD_OUTPUT_50HZ|
                     GPIO_CTL0_PIN_4_CB_AFIO_OUTPUT_PUSH_PULL|
                     GPIO_CTL0_PIN_5_CB_AFIO_OUTPUT_PUSH_PULL|
                     GPIO_CTL0_PIN_7_CB_AFIO_OUTPUT_PUSH_PULL);
